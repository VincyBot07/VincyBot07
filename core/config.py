...
class ConfigManager:
        ...
        if os.path.exists(config_json):
            ...
            with open(config_json, "r", encoding="utf-8") as f:
                ...
                try:
                    ...
                    logger.critical("Non è stato possibile caricare gli environment da config.json.", exc_info=True)
        self._cache = data
    ...
    def __setitem__(self, key: str, item: typing.Any) -> None:
        ...
        if key not in self.all_keys:
            raise InvalidConfigError(f'La configurazione "{key}" non è valida.')
    ...
    def filter_default(cls, data: typing.Dict[str, typing.Any]) -> typing.Dict[str, typing.Any]:
        ...
        for k, v in data.items():
            ...
            if default is Default:
                logger.error("Configurazione inaspettata rilevata: %s.", k)
                continue
            if v != default:
                filtered[k.lower()] = v
        return filtered
