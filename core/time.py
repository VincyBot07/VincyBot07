...
class ShortTime:
    ...
    def __init__(self, argument):
        ...
        if match is None or not match.group(0):
            raise BadArgument("Orario specificato non valido.")
...
class HumanTime:
    ...
    def __init__(self, argument):
        ...
        if not status.hasDateOrTime:
            raise BadArgument('L\'orario specificato non è valido, prova per esempio "tomorrow" oppure "3 days".')
...
class FutureTime(Time):
    def __init__(self, argument):
        ...
        if self._past:
            raise BadArgument("Quest'orario è nel passato.")
