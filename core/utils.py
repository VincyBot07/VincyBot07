...
def format_preview(messages: typing.List[typing.Dict[str, typing.Any]]):
    ...
    return out or "Nessun messaggio"
...
def days(day: typing.Union[str, int]) -> str:
    ...
    if day == 0:
        return "**today**"
    return f"{day} giorno fa" if day == 1 else f"{day} giorni fa"
...
TOPIC_REGEX = re.compile(r"\bID utente:\s*(\d{17,21})\b", flags=re.IGNORECASE)
